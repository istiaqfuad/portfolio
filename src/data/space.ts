...
export const spaceNodes: SpaceNode[] = [
  // AI / ML cluster (right)
  { id: "tribne", label: "TriBne-e5", kind: "project", domain: "nlp", x: 0.74, y: 0.4, r: 13, vec: [0.95, 0.9, 0.1, 0.2, 0.95] },
  ...
  { id: "hf", label: "Hugging Face", domain: "nlp", x: 0.9, y: 0.62, r: 8, vec: [0.8, 0.8, 0.15, 0.2, 0.6] },
  ...
  { id: "java", label: "Java", domain: "web", x: 0.3, y: 0.62, r: 8, vec: [0.05, 0.15, 0.75, 0.7, 0.1] },
  { id: "django", label: "Django", domain: "web", x: 0.2, y: 0.74, r: 8, vec: [0.1, 0.15, 0.8, 0.6, 0.1] },
